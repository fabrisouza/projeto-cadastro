...
def busca_cnpj(cnpj):
    ...
    if dic["status"] == "ERROR":
        ...
        try:
            ...
            print(
                "CNPJ: {0}   Data de abertura: {1}".format(dic["cnpj"], dic["abertura"])
            )
            print("Natureza: {0}".format(dic["natureza_juridica"]))
            print(
                "Situação: {0}  Situação especial: {1}  Tipo: {2}".format(
                    dic["situacao"], dic["situacao_especial"], dic["tipo"]
                )
            )
            ...
            print(
                " " * 10
                + "{0} - {1}".format(
                    dic["atividade_principal"][0]["code"],
            ...
            print("Endereço:")
            print(" " * 10 + "{0}, {1}".format(dic["logradouro"], dic["numero"]))
            print(" " * 10 + "{0}".format(dic["complemento"]))
            print(" " * 10 + "{0}, {1}".format(dic["municipio"], dic["uf"]))
